...
import com.beatsportable.beats.DataParser;
import com.beatsportable.beats.MenuStartGame;
import com.beatsportable.beats.MusicService;
import com.beatsportable.beats.R;
import com.beatsportable.beats.Randomizer;
...
public class GUIGame extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (orientation != ROTATABLE) setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED);
