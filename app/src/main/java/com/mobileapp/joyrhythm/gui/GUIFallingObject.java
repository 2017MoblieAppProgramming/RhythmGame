package com.mobileapp.joyrhythm.gui;

import com.mobileapp.joyrhythm.DataNote;
...
public abstract class GUIFallingObject {
	...
	public GUIScore.AccuracyTypes onFirstFrame(int currentTime, GUIScore score) {
		...
		GUIScore.AccuracyTypes acc = score.newEventHit(start_time - currentTime);
		...
		if (acc == GUIScore.AccuracyTypes.X_IGNORE_BELOW) return GUIScore.AccuracyTypes.X_IGNORE_ABOVE;
	...
	public GUIScore.AccuracyTypes onLastFrame(int currentTime, GUIScore score, boolean timeout) {
	...
	public GUIScore.AccuracyTypes onMiss(GUIScore score) {
